...
public class ChatAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.user = (TextView) convertView.findViewById(R.id.txtSender);
            holder.message = (TextView) convertView.findViewById(R.id.txtMessage);
            holder.timeStamp = (TextView) convertView.findViewById(R.id.txtDate);
    ...
    private int getMessageDirection(ChatMessage msg) {

        if (msg.getDeviceType().equalsIgnoreCase("Android")) {
            return DIRECTION_OUTGOING;
        } else {
            return DIRECTION_INCOMING;
        }
    ...
    public int getItemViewType(int position) {
        ...
        if (msg.getDeviceType().equalsIgnoreCase("Android")) {
            return DIRECTION_OUTGOING;
        } else if (msg.getDeviceType().equalsIgnoreCase("Web")) {
            return DIRECTION_INCOMING;
        }
        return position;
    }
